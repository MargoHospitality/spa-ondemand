 ...
 */
export function calculateClientDeadline(slotTime, now = new Date(), config = { delayLongHours: 24, delay24hHours: 2 }) {
 ...
 */
export function isWithinOpeningHours(time, openingTime, // "HH:MM"
closingTime) {
 ...
 */
export function calculateManagerDeadline(notifiedAt, delayMinutes, openingTime, closingTime) {
